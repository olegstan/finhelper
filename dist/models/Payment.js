...
var Payment = exports["default"] = /*#__PURE__*/function (_BaseModel) {
  function Payment(attributes) {
    var _this;
    _classCallCheck(this, Payment);
    _this = _callSuper(this, Payment);
    /**
     *
     * @type {string}
     */
    _defineProperty(_this, "controller", 'active_payment');
  ...
  return _createClass(Payment, [{
    ...
    get: function get() {
      if (!this.modelFields.account.loaded && this.attributes['account_id']) {
        this.attributes['account'] = _ModelHelper["default"].getUserAccountById(this.attributes['account_id']);
