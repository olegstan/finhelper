...
var _Active2 = _interopRequireDefault(require("../helpers/Active"));
...
var Active = exports["default"] = /*#__PURE__*/function (_BaseModel) {
  /**
   *
   * @param {Array} attributes
   */
  function Active(attributes) {
    var _this;
    _classCallCheck(this, Active);
    _this = _callSuper(this, Active);
    /**
     *
     * @type {string}
     */
    ...
    _defineProperty(_this, "currencyFields", ['buy_currency', 'income_currency', 'sell_currency']);
    _this.attributes = attributes;
    _this.setGetters(attributes);
    return _this;
  }
  _inherits(Active, _BaseModel);
  return _createClass(Active, [{
      ...
      if (this['tmp_avg_own_date'] === null || typeof this['tmp_avg_own_date'] === 'undefined') {
        ...
        if (buyTrades !== null && buyTrades !== void 0 && buyTrades.length) {
          for (var i = 0; i < buyTrades.length; i++) {
            ...
            date = _Active2["default"].getAvgDate(trade, date);
          }
        ...
        if (sellTrades !== null && sellTrades !== void 0 && sellTrades.length) {
          for (var _i = 0; _i < sellTrades.length; _i++) {
            ...
            date = _Active2["default"].getAvgDate(_trade, date);
          }
          this['tmp_avg_own_date'] = date ? date.format('DD.MM.YYYY') : '';
        }
      }
    ...
    get: function get() {
      if (this['tmp_valuation'] === null || typeof this['tmp_valuation'] === 'undefined') {
        var obj = _ActiveValuer["default"].getValuation(this.attributes, (0, _moment["default"])());
        if (obj) {
    ...
    key: "period",
    get: function get() {
      return _InvestCalc["default"].getPeriod(this, (0, _moment["default"])());
    }
  }, {
    key: "buySum",
    get: function get() {
      return _InvestCalc["default"].getBuySum(this, '');
    }
  }, {
    key: "buyOriginalSum",
    get: function get() {
      return _InvestCalc["default"].getBuyOriginalSum(this);
    }
  }, {
    key: "originDiffSum",
    get: function get() {
      var _ActiveValuer$getDiff;
      var now = (0, _moment["default"])();
      return (_ActiveValuer$getDiff = _ActiveValuer["default"].getDiffCurrency(this, now)) === null || _ActiveValuer$getDiff === void 0 ? void 0 : _ActiveValuer$getDiff.sum;
    }
  }, {
    key: "diffSum",
    get: function get() {
      var _ActiveValuer$getDiff2;
      var now = (0, _moment["default"])();
      return (_ActiveValuer$getDiff2 = _ActiveValuer["default"].getDiff(this, now, '', '')) === null || _ActiveValuer$getDiff2 === void 0 ? void 0 : _ActiveValuer$getDiff2.sum;
    }
  }, {
    key: "originValuation",
    get: function get() {
      if (this['tmp_originValuation'] === null || typeof this['tmp_originValuation'] === 'undefined') {
        var obj = _ActiveValuer["default"].getOriginalValuation(this.attributes, (0, _moment["default"])());
        if (obj) {
    ...
    get: function get() {
      return _helpers.Money.format(this.originValuation) + ' ' + _constants.CurrencyConstants.getCurrencySignByActive(this);
    }
  }, {
    key: "getFactPercent",
    value: function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _InvestCalc["default"].getFactPercentByItem(this);
            case 3:
              this['tmp_factPercent'] = _context.sent;
              _context.next = 6;
              return _InvestCalc["default"].getAnnuallyPercentByItem(this);
            case 6:
              this['tmp_annuallyPercent'] = _context.sent;
            case 7:
              return _context.abrupt("return", this['tmp_factPercent']);
            case 8:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _InvestCalc["default"].getFactPercentByItem(this);
            case 3:
              this['tmp_factPercent'] = _context2.sent;
              _context2.next = 6;
              return _InvestCalc["default"].getAnnuallyPercentByItem(this);
            case 6:
              this['tmp_annuallyPercent'] = _context2.sent;
            case 7:
              return _context2.abrupt("return", this['tmp_annuallyPercent']);
            case 8:
            case "end":
