...
var _default = exports["default"] = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        fonts = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : [];
        callback = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : function () {};
        _context2.next = 4;
        return fonts;
      case 4:
        _iterator = _createForOfIteratorHelper(fonts);
        _context2.prev = 5;
        _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
          ...
          return _regeneratorRuntime().wrap(function _loop$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                font = _step.value;
                document.fonts.check("80px ".concat(font)) ? document.fonts.load("80px ".concat(font)).then(function () {
                  console.log("Font: ".concat(font, " loaded \u2714\uFE0F"));
                }) : console.log("Font: ".concat(font, " not founded \u274C"));
              case 2:
              case "end":
