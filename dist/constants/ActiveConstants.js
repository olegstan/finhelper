...
export default class ActiveConstants {
  ...
  static GROUP_QUERY_CATALOG = [ActiveConstants.STOCK, ActiveConstants.ETF, ActiveConstants.OBLIGATION, ActiveConstants.FUTURES, ActiveConstants.PIF, ActiveConstants.PRECIOUS_METAL, ActiveConstants.CRYPTO];
  ...
  static CATALOGS = [ActiveConstants.CB_CATALOG, ActiveConstants.YAHOO_CATALOG, ActiveConstants.MOEX_CATALOG, ActiveConstants.CUSTOM_CATALOG, ActiveConstants.CBONDS_CATALOG];
  static DAILY = 1;
  static WEEKLY = 2;
  static MONTHLY = 3;
  static QUARTER = 4;
