...
class InvestCalc
{
  ...
  static calculateCurrencyValuations(activesOnlyCurrency) {
    ...
    const lastValuationsHash = crypto
      .createHash('md5')
      .update(lastValuationsJSON)
      .digest('hex');
  ...
  static getFactPercentByActives(actives)
  {
    ...
    const { currencyIndex, lastValuations, lastValuationsHash } = InvestCalc.calculateCurrencyValuations(activesOnlyCurrency);
