export default class ContactTaskRepeatConstants
{
  ...
  static statuses = [
    ContactTaskRepeatConstants.REPEAT_NONE,
    ContactTaskRepeatConstants.REPEAT_DAILY,
    ContactTaskRepeatConstants.REPEAT_WEEKLY,
    ContactTaskRepeatConstants.REPEAT_MONTHLY,
  ];
